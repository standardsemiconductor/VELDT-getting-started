...
## Table of Contents
[Introduction & Setup](https://github.com/standardsemiconductor/VELDT-getting-started#introduction--setup)
1. [Section 1: Fiat Lux](https://github.com/standardsemiconductor/VELDT-getting-started#section-1-fiat-lux)
...
2. [Section 2: Roar](https://github.com/standardsemiconductor/VELDT-getting-started#section-2-roar)
3. [Section 3: Pride](https://github.com/standardsemiconductor/VELDT-getting-started#section-3-pride)
4. [Section 4: Where Lions Roam](https://github.com/standardsemiconductor/VELDT-getting-started#section-4-where-lions-roam)
...
This guide is split into several sections. Each section begins with construction of sub-components then culminates with an application which utilizes the sub-components. [Section 1](https://github.com/standardsemiconductor/VELDT-info#section-1) constructs a simple blinker, the "hello-world" of FPGAs. [Section 2] covers serializers and deserializers which are used to construct a UART. In [Section 3] we learn how to interact with the memory provided by VELDT. In [Section 4] we design a simple CPU with a custom ISA, then integrate our LED, UART, and memory peripherals to create a stored-program computer. By the end of the guide, you will have a library of commonly used sub-components along with a directory of applications demonstrating their useage. The library and demos explained in this guide are available in this repo, see the [veldt] and [test] directories.
